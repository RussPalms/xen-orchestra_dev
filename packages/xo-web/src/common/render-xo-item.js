...
const xoItemToRender = {
  ...
  backup: backup => (
    <span>
      ...
      {backup.differential === true && <span className='tag tag-info'>{_('backupIsDifferencing')} </span>}
      {backup.differential === false && <span className='tag tag-info'>{_('backupisKey')} </span>}
